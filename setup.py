...
STATUS = {False: "Development Status :: 4 - Beta", True: "Development Status :: 5 - Production/Stable"}
...
extensions = [
    Extension(
        "cusim.ioutils.ioutils_bind",
        sources=util_srcs + ["cusim/ioutils/bindings.cc", "3rd/json11/json11.cpp"],
        language="c++",
    ...
    Extension(
        "cusim.culda.culda_bind",
        sources=util_srcs + ["cpp/src/culda/culda.cu", "cusim/culda/bindings.cc", "3rd/json11/json11.cpp"],
        language="c++",
        extra_compile_args=extra_compile_args,
        extra_link_args=["-fopenmp"],
    ...
    Extension(
        "cusim.cuw2v.cuw2v_bind",
        sources=util_srcs + ["cpp/src/cuw2v/cuw2v.cu", "cusim/cuw2v/bindings.cc", "3rd/json11/json11.cpp"],
        language="c++",
        extra_compile_args=extra_compile_args,
        extra_link_args=["-fopenmp"],
        library_dirs=[CUDA["lib64"]],
